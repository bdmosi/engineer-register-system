...
class PersoninfoController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Personinfo');
	...
	{
		$model=new Personinfo('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['Personinfo'])) {
			$model->attributes=$_GET['Personinfo'];
		}
	...
	{
		$model=Personinfo::model()->findByPk($id);
		if ($model===null) {
	 ...
	 * @param Personinfo $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='personinfo-form') {
